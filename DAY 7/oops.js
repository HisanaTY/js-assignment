class user{
    ...
        addcoins(){
            this.coins++;
            console.log(`The number of coins is ${this.coins}`);
        }
        removecoins(){
    ...
    var user1=new user(`Alen`,21,`a@gmail.com`);
    var user2=new moderator(`Meena`,21,`m@gmail.com`);
    var user3=new admin(`Joseph`,21,`j@gmail.com`);
    user1.login();
    user1.logout();
    user2.addcoins();
